        ...
        for file_in_notedir in files_in_notedir:
            ...
            if file_in_notedir.endswith('.wav'):
                ...
                try:
                    ...
                    print("Couldn't cut head")
                    sensor_data_noHead = sensor_data
                ...
                try:
                    ...
                    print("Couldn't cut tail")
                    sensor_data_noTail = sensor_data_noHead
                ...
                sensor_name = f'{sample_name}-sensors-left-{note_index}_f0.npy'
                sensor_path = f'data-processed/{sample_name}/{sensor_name}'
                np.save(sensor_path, cent_static)
